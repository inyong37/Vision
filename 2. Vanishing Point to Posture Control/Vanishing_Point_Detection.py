...
# Vanishing Point Detection Version 2
# Reference
# Vanishing Point Detection: https://github.com/SZanlongo/vanishing-point-detection/blob/master/src/vanishing_point.py
# Time: https://godoftyping.wordpress.com/2015/04/19/python-%EB%82%A0%EC%A7%9C-%EC%8B%9C%EA%B0%84%EA%B4%80%EB%A0%A8-%EB%AA%A8%EB%93%88/
...
def find_vanishing_point(img, grid_size, intersections):
    ...
    if best_cell[0] != None and best_cell[1] != None:
        ...
        fileroute = '/output/'
        filename = fileroute+'center'+now+'.jpg'
        cv2.imwrite(filename, img)
        '''
        cv2.imwrite('center1.jpg', img)
    return best_cell
